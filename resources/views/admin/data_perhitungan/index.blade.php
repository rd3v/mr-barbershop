...
<div class="padding">
  ...
  <div class="box">
    <div class="box-header">
      <h2 style="display:inline"><b>Perhitungan Waiting Line</b></h2>
    </div>
    <br>
...
@section('script')
<script>
  $("li#perhitungan-waiting-line").addClass('active');
  ...
  $("input#melayani_rata_rata_pelanggan").on('input', function() {
    ...
    var lq = Math.round((Math.pow(round_hasil,2)) / (melayani_rata_rata_pelanggan * (melayani_rata_rata_pelanggan - round_hasil)));
    ...
    var wq_menit = Math.round((wq * 60 / 100) * 100);
    var wq_detik = wq_menit * 60;
    $("span#wq").html(wq);
    $("span#wq_menit").html(wq_menit);
    $("span#wq_detik").html(wq_detik);
    
    var w = (wq / (round_hasil / nilai)).toFixed(1);
    var w_menit = Math.round((w * 60 / 100) * 100);
    var w_detik = w_menit * 60;
    $("span#w").html(w);
    $("span#w_menit").html(w_menit);
    $("span#w_detik").html(w_detik);

  });

const style="color:red;font-size: 24px";
console.log("%c Made By Fikra",style);
</script>
@endsection
