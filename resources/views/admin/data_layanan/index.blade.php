...
<div class="padding">
  ...
  <div class="box">
    <div class="box-header">
      <h2 style="display:inline"><b>Data Layanan</b></h2>
      <a href="{{ url('/data-layanan/tambah') }}" class="btn btn-success btn-md" style="color: white;float: right">+Tambah</a>
    </div>
    <br>
...
<script>
  ...
  $(".btn-hapus").click(function() {
    ...
    if(!confirm('Hapus Layanan ' + jenis_layanan)) return false;
      ...
      $('#hapus_form').attr('action', "/data-layanan/delete/" + id).submit();
