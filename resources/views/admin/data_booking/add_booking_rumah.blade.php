...
<div class="padding">
  ...
  <div class="box">
    <div class="box-header">
      <h2 style="display:inline"><b>Booking di Rumah</b></h2>
    </div>


    <div class="box-divider m-a-0"></div>
        <div class="box-body">
          <form role="form" action="{{ url('/data-layanan/store') }}" method="post">
            @csrf
            <div class="form-group row">
              <label for="jenis_layanan" class="col-sm-2 form-control-label">Jenis Layanan</label>
              <div class="col-sm-10">
                <input type="text" name="jenis_layanan" class="form-control" id="jenis_layanan" placeholder="Masukkan Jenis Layanan" required="">
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="number" name="harga_layanan" class="form-control" id="harga_layanan" placeholder="Masukkan Harga Layanan" required>
              </div>
            </div>
