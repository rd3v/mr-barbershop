...
<div class="padding">
  ...
  <div class="box">
    <div class="box-header">
      <h2 style="display:inline"><b>Tambah Data Pelanggan</b></h2>
    </div>


<div class="box-divider m-a-0"></div>
        <div class="box-body">
          <form role="form" action="{{ url('/data-pelanggan/store') }}" method="post">
            @csrf
            <div class="form-group row">
              <label for="inputName" class="col-sm-2 form-control-label">Nama</label>
              <div class="col-sm-10">
                <input type="text" name="name" class="form-control" id="inputName" placeholder="Masukkan Nama" required="">
              </div>
            </div>
            ...
            <div class="form-group row m-t-md">
              <div class="col-sm-offset-2 col-sm-10">
                ...
                <a href="{{ url('/data-pelanggan') }}" type="button" class="btn danger">Batal</a>
              </div>
            </div>
          </form>
        </div>
...
@section('script')
<script>
  $("li#data-pelanggan").addClass('active');
</script>
@endsection