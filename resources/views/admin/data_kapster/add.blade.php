...
<div class="padding">
  ...
  <div class="box">
    <div class="box-header">
      <h2 style="display:inline"><b>Tambah Data Kapster</b></h2>
    </div>


<div class="box-divider m-a-0"></div>
        <div class="box-body">
          <form role="form" action="{{ url('/data-kapster/store') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                ...
                <br>
                <center>
                    <img src="" alt="Gambar" id="image" width="25%" style="display:none">
                </center>                
              </div>
            </div>
